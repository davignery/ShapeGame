...
namespace TouchScript.Editor.Gestures.TransformGestures.Base
{
	internal class TransformGestureBaseEditor : GestureEditor
	{
		...
		public static readonly GUIContent TEXT_MIN_SCREEN_POINTS_DISTANCE = new GUIContent("Min MyPoints Distance (cm)", "Minimum distance between two pointers (clusters) in cm to consider this gesture started. Used to prevent fake pointers spawned near real ones on cheap multitouch hardware to mess everything up.");
